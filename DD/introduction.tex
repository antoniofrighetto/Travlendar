...
\begin{tabular}{SSSS} \toprule
    ...
    1.1 & {22/11/17} & {Antonio Frighetto, Leonardo Givoli, Hichame Yessou} & {Fix \& Review} \\ \midrule
    1.0 & {26/11/17} & {Antonio Frighetto, Leonardo Givoli, Hichame Yessou} & {Initial version} \\ \bottomrule
\end{tabular}
